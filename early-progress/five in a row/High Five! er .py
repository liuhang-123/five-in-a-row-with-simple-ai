...
class Five:
							...
							if self.points[self.jz +dire*-1][1]==mode:
								...
								if self.points[self.jz +dire*-2][1]==mode and self.points[self.jz +dire*-2][1]==mode:
									...
									if self.points[self.jz +dire*-3][1]==mode*-1+3 or self.points[self.jz +dire*2][1]==mode*-1+3:
										pppp-=99000*atad
							#gensit _/.
							elif self.points[self.jz +dire*-1][1]==0:
								pppp+=60*atad
								# ._/.
								if self.points[self.jz +dire*-2][1]==mode:
									pppp+=500*atad
							#gensit 0/._ or _/.0
							elif self.points[self.jz +dire*-1][1]==mode*-1+3 or self.points[self.jz +dire*2][1]==mode*-1+3:
								pppp-=80*atad
							...
							if self.points[self.jz + dire*2][1]==mode:
								...
								#gensit _/..
									...
									if self.points[self.jz +dire*-2][1]==mode:
										pppp+=5000*atad
								#gensit 0/.. or /..0
								elif self.points[self.jz +dire*-1][1]==mode*-1+3 or self.points[self.jz + dire*3][1]==mode*-1+3:
									pppp-=930*atad
								...
								if self.points[self.jz +dire*3][1]==mode:
									...
									if self.points[self.jz +dire*-1][1]==mode:
										pppp+=10000000*atad
									#0/...	or /...0
									elif self.points[self.jz +dire*-1][1]==mode*-1+3 or self.points[self.jz +dire*4][1]==mode*-1+3:
										pppp-=9200*atad
									#fo4 d
									#gensit /....
	...
	def enclose(self):
		...
		self.saveex=True
		pygame.draw.rect(self.screen,[225,240,30],[10,10,100,100],0)
