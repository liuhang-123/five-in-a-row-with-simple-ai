		...
		for points in self.points[:-21]:
			...
			if points[1]==0:
				...
				if self.points[self.jz+1][1] ==1:
					if 	self.points[self.jz-1][1]==1 or self.points[self.jz+2][1]==1:
						if self.points[self.jz-2][1]==2 or self.points[self.jz+3][1]==2:
							if self.points[self.jz-2][1]==2 and self.points[self.jz+3][1]==2:
								pass
							else:
								pppp+=40
						else:
							pppp+=100
					if self.points[self.jz-1][1]==2 or self.points[self.jz+2][1]==2:
					...
					if self.points[self.jz+2][1] ==1:
						if self.points[self.jz-1][1]==2 or self.points[self.jz+3][1]==2:
						...
						if self.points[self.jz+3][1] ==1:
							if self.points[self.jz-1][1]==2 or self.points[self.jz+4][1]==2:
				...
				if self.points[self.jz+19][1]==1:
					if 	self.points[self.jz-19][1]==1 or self.points[self.jz+19*2][1]==1:
						if self.points[self.jz-19*2][1]==2 or self.points[self.jz+19*3][1]==2:
							if self.points[self.jz-19*2][1]==2 and self.points[self.jz+19*3][1]==2:
								pass
							else:
								pppp+=40
						else:
				...
				if self.points[self.jz+18][1]==1:
					if 	self.points[self.jz-18][1]==1 or self.points[self.jz+18*2][1]==1:
						if self.points[self.jz-18*2][1]==2 or self.points[self.jz+18*3][1]==2:
							if self.points[self.jz-18*2][1]==2 and self.points[self.jz+18*3][1]==2:
								pass
							else:
								pppp+=40
						else:
				...
				if self.points[self.jz+20][1]==1:
					if 	self.points[self.jz-20][1]==1 or self.points[self.jz+20*2][1]==1:
						if self.points[self.jz-20*2][1]==2 or self.points[self.jz+20*3][1]==2:
							if self.points[self.jz-20*2][1]==2 and self.points[self.jz+20*3][1]==2:
								pass
							else:
								pppp+=40
						else:
				...
				if self.points[self.jz+1][1] ==2:
					if 	self.points[self.jz-1][1]==2 or self.points[self.jz+2][1]==2:
						if self.points[self.jz-2][1]==1 or self.points[self.jz+3][1]==1:
							if self.points[self.jz-2][1]==1 and self.points[self.jz+3][1]==1:
								pass
							else:
								pppp+=40
						else:
					...
					if self.points[self.jz+2][1] ==2:
						if self.points[self.jz-1][1]==1 or self.points[self.jz+3][1]==1:
						...
						if self.points[self.jz+3][1] ==2:
							if self.points[self.jz-1][1]==1 or self.points[self.jz+4][1]==1:
